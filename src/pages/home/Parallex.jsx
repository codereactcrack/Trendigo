  ...
  return (
    <div className="wrapper">
      ...
      <div className="sect">
        ...
        <button className="shop-button" onClick={() => navigate('/shop/category/men')}>SHOP</button>
        </p>
        <div className="bg bg1">
          <h2 className="desc">WOMEN
          <button className="shop-button" onClick={() => navigate('/shop/category/women')}>SHOP</button>
          </h2>
        </div>
        ...
        <p className="text">
          ...
          <button className="shop-button" onClick={() => navigate('/shop/category/furniture')}>SHOP</button>
        </p>
        <div className="bg bg2">
          <h2 className="desc">BEAUTY
            <button className="shop-button" onClick={() => navigate('/shop/category/beauty')}>SHOP</button>
          </h2>
        </div>
        ...
        <p className="text">
          Upgrade your tech game with our latest electronics. Whether it's cutting-edge gadgets, home appliances, or personal devices, we have everything you need to stay connected and efficient. Explore our range for innovative solutions.
            <button className="shop-button" onClick={() => navigate('/shop/category/electronics')}>SHOP</button>
        </p>
        <div className="bg bg3">
          <h2 className="desc">OTHERS
            <button className="shop-button" onClick={() => navigate('/shop/category/others')}>SHOP</button>
          </h2>
        </div>
      </div>
    </div>
