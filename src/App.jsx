...
import SellerDashboardRoute from './component/Auth/ProtectedRoute/SellerDashboardRoute';
    ...
    createRoutesFromElements(
      <Route>
        <Route path='/' element={<Template/>}>
          ...
          <Route path='product-list' element = {<SellerDashboardRoute element={<ProductList />} />} />
